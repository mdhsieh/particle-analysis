...
from detection_module.detect_config import Config
...
if __name__ == '__main__':
    ...
    # Create model
    if args.command == "train":
        model = detectlib.MaskRCNN(mode="training", config=config,
                                  model_dir=args.logs)
    else:
        model = detectlib.MaskRCNN(mode="inference", config=config,
                                  model_dir=args.logs)
